...
export const repropediaModules: RepropediaItem[] = [
  ...
  },
  {
    ...
    synopsis: "Analisis komprehensif dampak kesehatan reproduksi, sosial, dan ekonomi dari pernikahan usia dini.",
    content: "Pernikahan di bawah usia 19 tahun memiliki risiko medis yang sangat tinggi bagi remaja perempuan. Panggul yang belum berkembang sempurna meningkatkan risiko persalinan macet, perdarahan, hingga kematian ibu dan bayi. Secara psikososial, anak kehilangan hak belajar dan bermain, memicu siklus kemiskinan baru karena keterbatasan pendidikan dan akses ekonomi.",
    pdfUrl: "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
    readTime: "7 menit",
  ...
  },
  {
    ...
    category: "hak-anak",
    synopsis: "Pelajari 4 hak dasar anak berdasarkan Konvensi PBB dan undang-undang perlindungan anak di Indonesia.",
    content: "Setiap individu di bawah usia 18 tahun dikategorikan sebagai anak dan memiliki hak mutlak: Hak Kelangsungan Hidup, Hak Tumbuh Kembang, Hak Perlindungan (dari kekerasan, eksploitasi, dan diskriminasi), serta Hak Berpartisipasi dalam menyatakan pendapat.",
    pdfUrl: "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf",
    readTime: "6 menit",
  ...
  },
  {
    ...
    synopsis: "Tips menghadapi kecemasan akademik, cyberbullying, dan menjaga self-esteem dari paparan media sosial.",
...
export const mediaItems: MediaItem[] = [
  ...
  },
  {
    ...
    content: "Video animasi menarik yang menjelaskan pentingnya menjaga kebersihan organ reproduksi, memahami konsekuensi perilaku seksual berisiko, serta hak perlindungan kesehatan bagi seluruh siswa sekolah menengah.",
  ...
  },
  {
    ...
    content: "Tonton rangkuman video aksi damai dan orasi edukatif yang diselenggarakan oleh Kader GARUDA SIGMA di alun-alun kota untuk menyuarakan perlindungan anak dari predator seksual.",
...
export const ugcItems: UgcItem[] = [
  {
    ...
    description: "Desain poster digital yang menggambarkan perbedaan jalan hidup antara melanjutkan sekolah vs menikah di usia anak.",
    mediaUrl: "https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&q=80&w=800",
  ...
  },
  {
    ...
    description: "Infografis sederhana namun padat informasi tentang risiko preeklampsia, bayi lahir prematur, dan robekan jalan lahir.",
    mediaUrl: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&q=80&w=800",
  ...
  },
  {
    ...
    description: "Karya seni bertema integritas tubuh dan hak anak untuk menolak sentuhan yang tidak pantas dari siapapun.",
    mediaUrl: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&q=80&w=800",
...
export const eventItems: EventItem[] = [
  {
    ...
    description: "Kegiatan edukasi interaktif yang diikuti oleh 120 siswa perwakilan OSIS se-kabupaten. Menghadirkan pembicara dari BKKBN dan Dinas Pemberdayaan Perempuan & Perlindungan Anak.",
    date: "14 Mei 2026",
  ...
  },
  {
    ...
    description: "Pelatihan intensif 3 hari untuk mencetak konselor sebaya baru yang mampu mendeteksi dini kekerasan seksual dan merujuk teman sebaya ke guru BK.",
    date: "10 Juni 2026",
...
export const counselingDirectory: Counselor[] = [
  ...
  },
  {
    ...
    locationMapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.521260322283!2d106.8195613507028!3d-6.194657195493392!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f417f7d6a5d1%3A0xc3f17d3b5b1df639!2sGrand%20Indonesia!5e0!3m2!1sid!2sid!4v1628151234567!5m2!1sid!2sid",
  },
  {
    id: "c4",
...
export const statisticsCases: StatRecord[] = [
  { year: 2022, "Desa Sukamaju": 12, "Desa Harapan": 8, "Desa Mekarjaya": 15, "Desa Kertajaya": 9 },
  { year: 2023, "Desa Sukamaju": 10, "Desa Harapan": 6, "Desa Mekarjaya": 11, "Desa Kertajaya": 7 },
  { year: 2024, "Desa Sukamaju": 7, "Desa Harapan": 3, "Desa Mekarjaya": 8, "Desa Kertajaya": 4 },
  { year: 2025, "Desa Sukamaju": 4, "Desa Harapan": 1, "Desa Mekarjaya": 3, "Desa Kertajaya": 2 },
  { year: 2026, "Desa Sukamaju": 2, "Desa Harapan": 0, "Desa Mekarjaya": 1, "Desa Kertajaya": 0 },
];
...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    id: "q2",
    category: "pernikahan-anak",
    questionText: "Berapakah batas usia minimal untuk melangsungkan pernikahan baik bagi laki-laki maupun perempuan sesuai UU No. 16 Tahun 2019?",
    options: [
      "16 tahun",
      "17 tahun",
      "18 tahun",
  ...
  },
  {
    id: "q3",
    category: "kekerasan-seksual",
    questionText: "Jika ada seseorang yang kamu kenal menyentuh area tubuh sensitifmu dan memintamu untuk merahasiakannya, tindakan terbaik apa yang harus segera kamu lakukan?",
    options: [
    ...
    correctAnswer: 2,
    explanation: "Area sensitif tubuhmu adalah hak pribadimu. Setiap sentuhan tidak nyaman atau rahasia yang mencurigakan wajib ditolak keras dan segera dilaporkan demi keselamatanmu."
  },
  {
    id: "q4",
    category: "hak-anak",
    ...
    correctAnswer: 2,
    explanation: "Empat hak dasar anak adalah hak kelangsungan hidup, hak tumbuh kembang, hak perlindungan, dan hak berpartisipasi. Memiliki kekayaan pribadi bukan salah satu hak dasar anak."
  },
  {
    id: "q5",
    category: "kesehatan-mental",
    questionText: "Saat kamu merasa cemas berlebihan dan tertekan secara emosional karena cyberbullying, langkah awal yang paling bijak untuk self-care adalah...",
    options: [
    ...
    correctAnswer: 1,
    explanation: "Melakukan digital detox membantu menenangkan pikiran dari paparan intimidasi siber. Bercerita kepada pendengar tepercaya/konselor SIGMA memberikan dukungan emosional yang sehat."
  }
];
