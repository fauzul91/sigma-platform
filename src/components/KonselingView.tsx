...
import { MessageSquare, MapPin, Clock, Navigation, ChevronRight } from "lucide-react";
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 flex gap-3">
                  ...
                  {contact.role !== "Kader GARUDA" && (
                    <button className="flex-1 py-2.5 rounded-xl border border-slate-200 text-neutral-dark text-xs font-bold hover:bg-slate-50 transition-all flex items-center justify-center space-x-2 cursor-pointer">
