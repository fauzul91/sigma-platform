  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setEditingMedia({
        ...editingMedia,
        mediaUrl: url,
        type: file.type.startsWith("video/") ? "video" : "article",
      });
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-extrabold text-neutral-dark">Manajemen Edukasi & Media</h1>
          <p className="text-xs text-slate-500 font-medium mt-0.5">Kelola artikel edukasi dan kampanye multimedia.</p>
        </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden overflow-x-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 border-b border-slate-100/80">
          ...
          <div className="text-xs font-bold text-slate-400">
            Total <span className="text-neutral-dark">{totalItems}</span> Konten
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                {editingMedia.type === "video" ? (
                  ...
                  <DragDropUpload
                    label="Featured Image (Media Gambar)"
