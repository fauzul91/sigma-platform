...
export function SkeletonBlock({ className = "" }: SkeletonBlockProps) {
  return (
    <div
      className={`bg-slate-200/80 dark:bg-slate-800 animate-pulse rounded-lg motion-reduce:animate-none ${className}`}
    />
  );
}
...
export function CardSkeleton() {
  return (
    <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-4 shadow-sm flex flex-col justify-between h-full space-y-4">
...
export function StatCardSkeleton() {
  return (
    <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm flex items-center space-x-4">
...
export function TableSkeleton({ cols = 5, rows = 6 }: TableSkeletonProps) {
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/60 dark:border-slate-800 shadow-sm overflow-hidden w-full">
      {/* Header skeleton */}
      <div className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800 px-6 py-4 flex items-center justify-between">
...
export function ListSkeleton() {
  return (
    <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm flex items-start space-x-4">
      {/* Icon circle */}
...
export function ChartSkeleton() {
  return (
    <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm space-y-6 w-full h-[320px] flex flex-col justify-between">
      {/* Header title */}
      ...
      <div className="grow flex items-end justify-between space-x-3 pt-6 border-b border-slate-100 dark:border-slate-800 pb-2">
