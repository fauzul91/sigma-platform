...
import { Heart, UserCheck, School, Upload, CheckCircle, Filter } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
          ...
          <button
            ...
            className="w-full md:w-auto px-5 py-3 rounded-xl bg-primary text-white font-bold hover:bg-primary-hover shadow-lg shadow-emerald-600/10 flex items-center justify-center space-x-2 transition-all active:scale-98 cursor-pointer"
          >
            ...
            >
              ...
              <div className="mt-4 pt-3.5 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400 font-semibold">
                ...
                <button
                  ...
                  className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg hover:bg-rose-50 text-slate-400 hover:text-rose-600 transition-colors cursor-pointer"
                >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between border-t border-slate-100 pt-4 text-xs font-bold">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-slate-400 font-semibold">{selectedUgc.school}</p>
                  </div>
                  <button
                    onClick={(e) => {
                    ...
                    className="flex items-center space-x-1.5 px-4.5 py-2 rounded-xl bg-rose-50 text-rose-600 hover:bg-rose-100 transition-colors cursor-pointer"
                  >
            ...
            <div className="w-full max-w-md bg-white rounded-3xl p-6 shadow-2xl border border-slate-100 animate-in zoom-in-95 duration-200">
              ...
              {formSubmitted ? (
                <div className="py-12 flex flex-col items-center justify-center text-center space-y-3">
                  ...
                  <p className="text-xs text-slate-500 leading-normal max-w-xs font-semibold">
                ...
                <form onSubmit={handleFormSubmit} className="mt-4 space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 rounded-xl bg-primary text-white font-extrabold text-xs hover:bg-primary-hover active:scale-98 transition-all flex items-center justify-center space-x-2 cursor-pointer"
                  >
