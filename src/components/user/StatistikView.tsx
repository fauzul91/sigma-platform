...
export default function StatistikView() {
  ...
  const declinePercentage = total2022 > 0 ? Math.round(((total2022 - total2026) / total2022) * 100) : 0;
                ...
                {isLoading ? (
                  Array.from({ length: 4 }).map((_, idx) => (
                    <tr key={idx} className="animate-pulse">
                      ...
                      <td className="py-3.5 px-4"><div className="h-4 bg-slate-200 rounded w-16" /></td>
                      <td className="py-3.5 px-4"><div className="h-4 bg-slate-200 rounded w-16" /></td>
                      <td className="py-3.5 px-4 text-right"><div className="h-4 bg-slate-200 rounded w-20 ml-auto" /></td>
                    </tr>
                  ))
                ) : (
