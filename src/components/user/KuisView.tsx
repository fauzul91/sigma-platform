...
interface QuizCategory extends QuizCategoryConfig {
  questions: LocalQuestion[];
}

export default function KuisView() {
  const [activeScreen, setActiveScreen] = useState<
    "topic" | "overview" | "play" | "results"
  >("topic");
  ...
  const categoryConfig: QuizCategoryConfig[] = [
    {
      id: "cat_repro",
      title: "Kesehatan Reproduksi",
      slug: "pubertas",
      description:
        "Pahami masa pubertas, perubahan hormon fisik, dan cara menjaga kebersihan reproduksi harian.",
      xpReward: 45,
      duration: "3 Menit",
      badgeName: "Healthy Teen",
      badgeDescription:
        "Telah memahami perubahan pubertas secara sehat & positif.",
      ...
      fallbackQuestions: [
        ...
        },
        {
          ...
          correctAnswer: 0,
          explanation:
            "Menarche adalah tanda biologis pertama dari kedewasaan reproduksi perempuan, menandai dimulainya fungsi siklus rahim.",
        },
        {
          id: "rep3",
          questionText:
          ...
          correctAnswer: 1,
          explanation:
            "Mengganti celana dalam minimal 2 kali sehari mencegah kelembapan berlebih yang dapat memicu pertumbuhan jamur dan bakteri berbahaya di area intim.",
        },
      ],
    },
    {
      ...
      description:
        "Ketahui batasan usia legal pernikahan di Indonesia dan risiko kesehatan kehamilan terlalu muda.",
      xpReward: 45,
      duration: "3 Menit",
      badgeName: "Anti Child Marriage Advocate",
      badgeDescription:
        "Telah memahami risiko pernikahan dini & batas kedewasaan legal.",
      ...
      fallbackQuestions: [
        {
          id: "mar1",
          questionText:
            "Berapakah batas usia minimal untuk melangsungkan pernikahan sesuai UU No. 16 Tahun 2019?",
        ...
        },
        {
          ...
          correctAnswer: 1,
          explanation:
            "Secara biologis, tulang panggul dan organ kandungan remaja belum matang sempurna, sehingga meningkatkan risiko robekan jalan lahir, pendarahan, dan tekanan darah tinggi (preeklamsia).",
        },
        {
          id: "mar3",
          questionText:
          ...
          correctAnswer: 1,
          explanation:
            "Pernikahan dini sering memaksa remaja meninggalkan bangku sekolah. Minimnya pendidikan membuat mereka sulit bersaing mendapatkan pekerjaan dengan pendapatan yang layak untuk menghidupi keluarga.",
        },
      ],
    },
    {
      ...
      slug: "hak-anak",
      description:
        "Pahami empat hak dasar anak berdasarkan Konvensi Hak Anak PBB untuk melindungi diri dan teman sebaya.",
      xpReward: 30,
      duration: "2 Menit",
      badgeName: "Child Rights Guardian",
      badgeDescription:
        "Menguasai perlindungan hukum & hak tumbuh kembang anak.",
      ...
      fallbackQuestions: [
        {
          ...
          correctAnswer: 2,
          explanation:
            "Empat hak dasar anak adalah hak kelangsungan hidup, hak tumbuh kembang, hak perlindungan, dan hak berpartisipasi. Hak memiliki harta pribadi bukan bagian dari hak dasar anak.",
        },
        {
          id: "rig2",
          questionText:
            "Hak anak untuk didengar pendapatnya dalam pengambilan keputusan yang menyangkut dirinya sendiri disebut...",
          options: [
            "Hak kelangsungan hidup",
            "Hak perlindungan",
            "Hak partisipasi",
          ...
          correctAnswer: 2,
          explanation:
            "Hak Partisipasi menjamin anak untuk menyuarakan aspirasi, didengarkan pandangannya, serta ikut berdiskusi pada masalah yang memengaruhi masa depannya.",
        },
      ],
    },
    {
      ...
      description:
        "Identifikasi tanda kecemasan berlebih, cyberbullying, dan cara mengelola stres belajar yang sehat.",
      xpReward: 30,
      duration: "2 Menit",
      badgeName: "Mental Care Explorer",
      badgeDescription:
        "Memahami manajemen stres & kepedulian kesehatan mental.",
      ...
      fallbackQuestions: [
        {
          id: "men1",
          questionText:
            "Saat kamu merasa cemas berlebihan dan tertekan secara emosional karena cyberbullying, langkah awal self-care yang bijak adalah...",
          options: [
          ...
          correctAnswer: 1,
          explanation:
            "Menjauhi media sosial sementara (digital detox) menenangkan saraf tegang, sementara bercerita memberikan pelepasan emosional yang sehat dan dukungan nyata.",
        },
        {
          id: "men2",
          questionText:
            "Menghadapi tumpukan tugas sekolah yang memicu stres, manajemen stres harian apa yang dianjurkan?",
          options: [
          ...
          correctAnswer: 1,
          explanation:
            "Melatih napas lambat menurunkan detak jantung cemas, sementara mencicil tugas kecil menjadikannya lebih mudah diselesaikan tanpa beban emosional berlebih.",
        },
      ],
    },
    {
      ...
      description:
        "Kenali batasan sentuhan aman, menolak tindakan mencurigakan, dan langkah pelaporan darurat.",
      xpReward: 30,
      duration: "2 Menit",
      badgeName: "GARUDA Champion",
      badgeDescription:
        "Memiliki keberanian menolak pelecehan & menjaga batasan pribadi.",
      ...
      fallbackQuestions: [
        {
          id: "vio1",
          questionText:
            "Jika ada seseorang yang kamu kenal mencoba menyentuh area tubuh sensitifmu secara tidak nyaman, tindakan terbaik apa yang harus dilakukan?",
          options: [
          ...
          correctAnswer: 2,
          explanation:
            "Tubuhmu adalah otoritas pribadimu. Tolak segala bentuk sentuhan yang membuatmu tidak nyaman, jauhi pelaku, dan langsung laporkan kepada orang dewasa tepercaya.",
        },
        {
          id: "vio2",
          questionText:
            "Apa definisi dari konsep 'Sentuhan Aman' (Safe Touch) dalam interaksi sehari-hari?",
          options: [
          ...
          correctAnswer: 0,
          explanation:
            "Sentuhan aman adalah bentuk kontak sosial wajar yang penuh rasa hormat, menghargai batasan pribadi, dan tidak memicu ketakutan atau ketidaknyamanan batin.",
        },
      ],
    },
  ];

  // State reaktif: mulai dari fallback, lalu diperbarui dari Supabase
  const [categories, setCategories] = useState<QuizCategory[]>(() =>
    categoryConfig.map((c) => ({ ...c, questions: c.fallbackQuestions })),
  );
    ...
    userService.getQuizQuestions().then((dbQuestions: QuizQuestion[]) => {
      setCategories(
        categoryConfig.map((c) => {
          const fromDb = dbQuestions
            .filter((q) => q.category === c.slug)
            .map((q) => ({
              id: q.id,
          ...
          return {
            ...c,
            questions: fromDb.length > 0 ? fromDb : c.fallbackQuestions,
          };
        }),
      );
    });
    // categoryConfig is defined inside the component but is referentially stable per render;
  ...
  const submitAnswer = () => {
    if (selectedOptionIdx === null || isAnswerSubmitted || !selectedCategory)
      return;
          ...
          <div className="bg-white rounded-3xl border border-slate-200/60 shadow-xl overflow-hidden p-6 space-y-6">
            <div className="text-center space-y-4 pb-4 border-b border-slate-100">
              ...
              <div className="space-y-1">
                ...
                <h2 className="text-2xl font-extrabold text-neutral-dark tracking-tight">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <p className="text-xs font-black text-neutral-dark mt-1">
              ...
              <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <p className="text-xs font-black text-neutral-dark mt-1">
                  {selectedCategory.questions.length} Soal
                </p>
              </div>
              <div className="p-3 bg-slate-50 rounded-2xl border border-slate-100">
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider">
            ...
            <div className="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100 flex items-center space-x-3.5">
              ...
              <div>
                ...
                <p className="text-xs font-extrabold text-neutral-dark mt-0.5">
                  {selectedCategory.badgeName}
                </p>
                <p className="text-[10px] text-slate-500 font-semibold leading-relaxed mt-0.5">
                  {selectedCategory.badgeDescription}
                </p>
              </div>
            </div>
        ...
        <div className="max-w-xl w-full space-y-6 animate-in fade-in duration-300 relative">
          ...
          <div className="w-full bg-slate-200/80 rounded-full h-2 overflow-hidden border border-slate-200/30">
            <div
              ...
              style={{
                width: `${(currentQuestionIdx / selectedCategory.questions.length) * 100}%`,
              }}
            />
          </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-200/60 p-6 md:p-8 shadow-xl space-y-6">
            ...
            <div className="space-y-3 pt-2">
              {selectedCategory.questions[currentQuestionIdx].options.map(
                (option, idx) => {
                  ...
                  let optionStyle =
                    "border-slate-200 hover:border-primary/50 hover:bg-slate-50/40 text-neutral-dark";
                  ...
                  if (isAnswerSubmitted) {
                    ...
                    optionStyle =
                      "border-primary bg-emerald-50/10 text-primary ring-2 ring-primary/10";
                  }
                  ...
                  return (
                    ...
                    >
                      ...
                      {isAnswerSubmitted && isSelected && !isCorrect && (
                        <XCircle className="h-4.5 w-4.5 text-amber-600 shrink-0" />
                      )}
                    </button>
                  );
                },
                  ...
                  selectedCategory.questions[currentQuestionIdx]
                    ...
                    <>
                      ...
                      <span className="text-emerald-700">
                        Luar Biasa! Jawabanmu Tepat (+15 XP)
                      </span>
                    </>
                  ) : (
                    <>
                      ...
                      <span className="text-amber-700">
                        Pelajari Ulang Penjelasan ini
                      </span>
                    </>
                  )}
                </div>
                <p>
                  {selectedCategory.questions[currentQuestionIdx].explanation}
                </p>
              </div>
            )}
          ...
          <div className="bg-white rounded-3xl border border-slate-200/60 p-6 md:p-8 shadow-xl text-center space-y-6 relative">
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
                Kamu telah menyelesaikan petualangan kuis ini. Setiap langkah
                kecil membantu meningkatkan perlindungan diri tepercaya!
              </p>
            </div>
            ...
            <div className="p-5 rounded-3xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white space-y-3 relative shadow-md">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-emerald-100 max-w-xs mx-auto leading-relaxed">
                  {selectedCategory.badgeDescription}
                </p>
              </div>
            </div>
                ...
                {correctAnswersCount === selectedCategory.questions.length ? (
                  <div className="space-y-1">
                    ...
                    <p className="font-semibold text-slate-600 leading-relaxed mt-1">
                      Keren! Kamu menguasai semua materi{" "}
                      <strong>{selectedCategory.title}</strong> secara mendalam.
                      Teruskan kontribusimu menyebarkan pemahaman ini!
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {correctAnswersCount > 0 && (
                      <div className="space-y-1">
                        ...
                        <p className="font-semibold text-slate-600 leading-relaxed mt-1">
                          ...
                          <strong>{selectedCategory.title}</strong> sudah
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="font-semibold text-slate-600 leading-relaxed mt-1">
                        Kamu masih keliru menjawab beberapa soal. Rekomendasi
                        bacaan untuk memperdalam pemahaman:
                      </p>
                      <Link
                      ...
                      >
                        ...
                        <span>
                          Baca Materi Repropedia {selectedCategory.title}
                        </span>
                      </Link>
                    </div>
                  </div>
