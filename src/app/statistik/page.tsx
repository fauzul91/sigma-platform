...
import { Info, TrendingDown, Eye, HelpCircle, Calendar, BarChart3, Database } from "lucide-react";
import { statisticsCases } from "@/data/mockData";
...
export default function StatistikPage() {
  ...
  const chartData = statisticsCases.map((record) => {
    const total = 
  ...
  // Calculate total cases in 2022 vs 2026 to show decline
