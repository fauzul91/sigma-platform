...
import { repropediaModules, RepropediaItem } from "@/data/mockData";

function RepropediaContent() {
  ...
  useEffect(() => {
    if (moduleSlug) {
      const found = repropediaModules.find((m) => m.slug === moduleSlug);
  ...
  const filteredModules = repropediaModules.filter((module) => {
          ...
          <div className="space-y-10 animate-in fade-in duration-300">
            ...
            <div className="text-center max-w-3xl mx-auto space-y-3">
              ...
              <p className="text-slate-500 text-sm md:text-base leading-relaxed">
                Materi edukasi reproduksi terpercaya, terstruktur, dan ramah ramaja. Pilih kategori bahasan di bawah untuk mulai membaca.
              </p>
            </div>
