...
import { Users, Eye, Target, Award, Heart, Shield } from "lucide-react";
    ...
    <div className="bg-slate-50 min-h-screen py-10 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-xl mx-auto mb-10">
          ...
          <p className="text-xs text-slate-500 mt-2 font-medium">Klik pada posisi pengurus untuk melihat tugas dan profil lengkap.</p>
        </div>
          ...
          <div className="lg:col-span-8 flex flex-col items-center bg-white p-6 md:p-8 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-10 relative">
              <button
                ...
                className={`px-4 py-2.5 rounded-xl border text-xs font-extrabold tracking-wide uppercase transition-all ${
            ...
            <div className="mb-10">
              <button
                ...
                className={`px-6 py-3.5 rounded-2xl border text-sm font-extrabold tracking-wide uppercase transition-all flex items-center space-x-2 ${
            ...
            <div className="grid grid-cols-2 gap-6 md:gap-12 mb-10 w-full max-w-md relative">
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl border text-xs font-extrabold tracking-wide uppercase transition-all ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg">
              <button
                ...
                className={`py-3 px-4 rounded-xl border text-xs font-extrabold tracking-wide uppercase transition-all flex items-center justify-center space-x-1.5 ${
